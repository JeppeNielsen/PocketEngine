...
template<> Pocket::Cloner* Pocket::GameObject::GetComponent<Pocket::Cloner>() { return (Pocket::Cloner*) GetComponent(26); }
template<> Pocket::Cloner* Pocket::GameObject::AddComponent<Pocket::Cloner>() { AddComponent(26); return (Pocket::Cloner*) GetComponent(26); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::Cloner>() { RemoveComponent(26); }
template<> Pocket::Cloner* Pocket::GameObject::CloneComponent<Pocket::Cloner>(GameObject* source) { CloneComponent(26, source); return (Pocket::Cloner*) GetComponent(26); }
template<> Pocket::Cloner* Pocket::GameObject::ReplaceComponent<Pocket::Cloner>(GameObject* source) { ReplaceComponent(26, source); return (Pocket::Cloner*) GetComponent(26); }
template<> void Pocket::GameObject::EnableComponent<Pocket::Cloner>(bool enable) { EnableComponent(26, enable); }
template<> Pocket::CloneVariable* Pocket::GameObject::GetComponent<Pocket::CloneVariable>() { return (Pocket::CloneVariable*) GetComponent(27); }
template<> Pocket::CloneVariable* Pocket::GameObject::AddComponent<Pocket::CloneVariable>() { AddComponent(27); return (Pocket::CloneVariable*) GetComponent(27); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::CloneVariable>() { RemoveComponent(27); }
template<> Pocket::CloneVariable* Pocket::GameObject::CloneComponent<Pocket::CloneVariable>(GameObject* source) { CloneComponent(27, source); return (Pocket::CloneVariable*) GetComponent(27); }
template<> Pocket::CloneVariable* Pocket::GameObject::ReplaceComponent<Pocket::CloneVariable>(GameObject* source) { ReplaceComponent(27, source); return (Pocket::CloneVariable*) GetComponent(27); }
template<> void Pocket::GameObject::EnableComponent<Pocket::CloneVariable>(bool enable) { EnableComponent(27, enable); }
template<> Pocket::EditorDropTarget* Pocket::GameObject::GetComponent<Pocket::EditorDropTarget>() { return (Pocket::EditorDropTarget*) GetComponent(28); }
template<> Pocket::EditorDropTarget* Pocket::GameObject::AddComponent<Pocket::EditorDropTarget>() { AddComponent(28); return (Pocket::EditorDropTarget*) GetComponent(28); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::EditorDropTarget>() { RemoveComponent(28); }
template<> Pocket::EditorDropTarget* Pocket::GameObject::CloneComponent<Pocket::EditorDropTarget>(GameObject* source) { CloneComponent(28, source); return (Pocket::EditorDropTarget*) GetComponent(28); }
template<> Pocket::EditorDropTarget* Pocket::GameObject::ReplaceComponent<Pocket::EditorDropTarget>(GameObject* source) { ReplaceComponent(28, source); return (Pocket::EditorDropTarget*) GetComponent(28); }
template<> void Pocket::GameObject::EnableComponent<Pocket::EditorDropTarget>(bool enable) { EnableComponent(28, enable); }
template<> Pocket::ProjectSettings* Pocket::GameObject::GetComponent<Pocket::ProjectSettings>() { return (Pocket::ProjectSettings*) GetComponent(29); }
template<> Pocket::ProjectSettings* Pocket::GameObject::AddComponent<Pocket::ProjectSettings>() { AddComponent(29); return (Pocket::ProjectSettings*) GetComponent(29); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::ProjectSettings>() { RemoveComponent(29); }
template<> Pocket::ProjectSettings* Pocket::GameObject::CloneComponent<Pocket::ProjectSettings>(GameObject* source) { CloneComponent(29, source); return (Pocket::ProjectSettings*) GetComponent(29); }
template<> Pocket::ProjectSettings* Pocket::GameObject::ReplaceComponent<Pocket::ProjectSettings>(GameObject* source) { ReplaceComponent(29, source); return (Pocket::ProjectSettings*) GetComponent(29); }
template<> void Pocket::GameObject::EnableComponent<Pocket::ProjectSettings>(bool enable) { EnableComponent(29, enable); }
template<> Pocket::FilePath* Pocket::GameObject::GetComponent<Pocket::FilePath>() { return (Pocket::FilePath*) GetComponent(30); }
template<> Pocket::FilePath* Pocket::GameObject::AddComponent<Pocket::FilePath>() { AddComponent(30); return (Pocket::FilePath*) GetComponent(30); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::FilePath>() { RemoveComponent(30); }
template<> Pocket::FilePath* Pocket::GameObject::CloneComponent<Pocket::FilePath>(GameObject* source) { CloneComponent(30, source); return (Pocket::FilePath*) GetComponent(30); }
template<> Pocket::FilePath* Pocket::GameObject::ReplaceComponent<Pocket::FilePath>(GameObject* source) { ReplaceComponent(30, source); return (Pocket::FilePath*) GetComponent(30); }
template<> void Pocket::GameObject::EnableComponent<Pocket::FilePath>(bool enable) { EnableComponent(30, enable); }
template<> Pocket::Spawner* Pocket::GameObject::GetComponent<Pocket::Spawner>() { return (Pocket::Spawner*) GetComponent(31); }
template<> Pocket::Spawner* Pocket::GameObject::AddComponent<Pocket::Spawner>() { AddComponent(31); return (Pocket::Spawner*) GetComponent(31); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::Spawner>() { RemoveComponent(31); }
template<> Pocket::Spawner* Pocket::GameObject::CloneComponent<Pocket::Spawner>(GameObject* source) { CloneComponent(31, source); return (Pocket::Spawner*) GetComponent(31); }
template<> Pocket::Spawner* Pocket::GameObject::ReplaceComponent<Pocket::Spawner>(GameObject* source) { ReplaceComponent(31, source); return (Pocket::Spawner*) GetComponent(31); }
template<> void Pocket::GameObject::EnableComponent<Pocket::Spawner>(bool enable) { EnableComponent(31, enable); }
template<> Pocket::Animation* Pocket::GameObject::GetComponent<Pocket::Animation>() { return (Pocket::Animation*) GetComponent(32); }
template<> Pocket::Animation* Pocket::GameObject::AddComponent<Pocket::Animation>() { AddComponent(32); return (Pocket::Animation*) GetComponent(32); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::Animation>() { RemoveComponent(32); }
template<> Pocket::Animation* Pocket::GameObject::CloneComponent<Pocket::Animation>(GameObject* source) { CloneComponent(32, source); return (Pocket::Animation*) GetComponent(32); }
template<> Pocket::Animation* Pocket::GameObject::ReplaceComponent<Pocket::Animation>(GameObject* source) { ReplaceComponent(32, source); return (Pocket::Animation*) GetComponent(32); }
template<> void Pocket::GameObject::EnableComponent<Pocket::Animation>(bool enable) { EnableComponent(32, enable); }
template<> Pocket::Animator* Pocket::GameObject::GetComponent<Pocket::Animator>() { return (Pocket::Animator*) GetComponent(33); }
template<> Pocket::Animator* Pocket::GameObject::AddComponent<Pocket::Animator>() { AddComponent(33); return (Pocket::Animator*) GetComponent(33); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::Animator>() { RemoveComponent(33); }
template<> Pocket::Animator* Pocket::GameObject::CloneComponent<Pocket::Animator>(GameObject* source) { CloneComponent(33, source); return (Pocket::Animator*) GetComponent(33); }
template<> Pocket::Animator* Pocket::GameObject::ReplaceComponent<Pocket::Animator>(GameObject* source) { ReplaceComponent(33, source); return (Pocket::Animator*) GetComponent(33); }
template<> void Pocket::GameObject::EnableComponent<Pocket::Animator>(bool enable) { EnableComponent(33, enable); }
...
template<> Pocket::Sound* Pocket::GameObject::GetComponent<Pocket::Sound>() { return (Pocket::Sound*) GetComponent(36); }
template<> Pocket::Sound* Pocket::GameObject::AddComponent<Pocket::Sound>() { AddComponent(36); return (Pocket::Sound*) GetComponent(36); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::Sound>() { RemoveComponent(36); }
template<> Pocket::Sound* Pocket::GameObject::CloneComponent<Pocket::Sound>(GameObject* source) { CloneComponent(36, source); return (Pocket::Sound*) GetComponent(36); }
template<> Pocket::Sound* Pocket::GameObject::ReplaceComponent<Pocket::Sound>(GameObject* source) { ReplaceComponent(36, source); return (Pocket::Sound*) GetComponent(36); }
template<> void Pocket::GameObject::EnableComponent<Pocket::Sound>(bool enable) { EnableComponent(36, enable); }
template<> Pocket::SoundEmitter* Pocket::GameObject::GetComponent<Pocket::SoundEmitter>() { return (Pocket::SoundEmitter*) GetComponent(37); }
template<> Pocket::SoundEmitter* Pocket::GameObject::AddComponent<Pocket::SoundEmitter>() { AddComponent(37); return (Pocket::SoundEmitter*) GetComponent(37); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::SoundEmitter>() { RemoveComponent(37); }
template<> Pocket::SoundEmitter* Pocket::GameObject::CloneComponent<Pocket::SoundEmitter>(GameObject* source) { CloneComponent(37, source); return (Pocket::SoundEmitter*) GetComponent(37); }
template<> Pocket::SoundEmitter* Pocket::GameObject::ReplaceComponent<Pocket::SoundEmitter>(GameObject* source) { ReplaceComponent(37, source); return (Pocket::SoundEmitter*) GetComponent(37); }
template<> void Pocket::GameObject::EnableComponent<Pocket::SoundEmitter>(bool enable) { EnableComponent(37, enable); }
template<> Pocket::SoundListener* Pocket::GameObject::GetComponent<Pocket::SoundListener>() { return (Pocket::SoundListener*) GetComponent(38); }
template<> Pocket::SoundListener* Pocket::GameObject::AddComponent<Pocket::SoundListener>() { AddComponent(38); return (Pocket::SoundListener*) GetComponent(38); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::SoundListener>() { RemoveComponent(38); }
template<> Pocket::SoundListener* Pocket::GameObject::CloneComponent<Pocket::SoundListener>(GameObject* source) { CloneComponent(38, source); return (Pocket::SoundListener*) GetComponent(38); }
template<> Pocket::SoundListener* Pocket::GameObject::ReplaceComponent<Pocket::SoundListener>(GameObject* source) { ReplaceComponent(38, source); return (Pocket::SoundListener*) GetComponent(38); }
template<> void Pocket::GameObject::EnableComponent<Pocket::SoundListener>(bool enable) { EnableComponent(38, enable); }
template<> Pocket::ParticleEmitter* Pocket::GameObject::GetComponent<Pocket::ParticleEmitter>() { return (Pocket::ParticleEmitter*) GetComponent(39); }
template<> Pocket::ParticleEmitter* Pocket::GameObject::AddComponent<Pocket::ParticleEmitter>() { AddComponent(39); return (Pocket::ParticleEmitter*) GetComponent(39); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::ParticleEmitter>() { RemoveComponent(39); }
template<> Pocket::ParticleEmitter* Pocket::GameObject::CloneComponent<Pocket::ParticleEmitter>(GameObject* source) { CloneComponent(39, source); return (Pocket::ParticleEmitter*) GetComponent(39); }
template<> Pocket::ParticleEmitter* Pocket::GameObject::ReplaceComponent<Pocket::ParticleEmitter>(GameObject* source) { ReplaceComponent(39, source); return (Pocket::ParticleEmitter*) GetComponent(39); }
template<> void Pocket::GameObject::EnableComponent<Pocket::ParticleEmitter>(bool enable) { EnableComponent(39, enable); }
template<> Pocket::ParticleEffect* Pocket::GameObject::GetComponent<Pocket::ParticleEffect>() { return (Pocket::ParticleEffect*) GetComponent(40); }
template<> Pocket::ParticleEffect* Pocket::GameObject::AddComponent<Pocket::ParticleEffect>() { AddComponent(40); return (Pocket::ParticleEffect*) GetComponent(40); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::ParticleEffect>() { RemoveComponent(40); }
template<> Pocket::ParticleEffect* Pocket::GameObject::CloneComponent<Pocket::ParticleEffect>(GameObject* source) { CloneComponent(40, source); return (Pocket::ParticleEffect*) GetComponent(40); }
template<> Pocket::ParticleEffect* Pocket::GameObject::ReplaceComponent<Pocket::ParticleEffect>(GameObject* source) { ReplaceComponent(40, source); return (Pocket::ParticleEffect*) GetComponent(40); }
template<> void Pocket::GameObject::EnableComponent<Pocket::ParticleEffect>(bool enable) { EnableComponent(40, enable); }
template<> Pocket::SlicedQuad* Pocket::GameObject::GetComponent<Pocket::SlicedQuad>() { return (Pocket::SlicedQuad*) GetComponent(41); }
template<> Pocket::SlicedQuad* Pocket::GameObject::AddComponent<Pocket::SlicedQuad>() { AddComponent(41); return (Pocket::SlicedQuad*) GetComponent(41); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::SlicedQuad>() { RemoveComponent(41); }
template<> Pocket::SlicedQuad* Pocket::GameObject::CloneComponent<Pocket::SlicedQuad>(GameObject* source) { CloneComponent(41, source); return (Pocket::SlicedQuad*) GetComponent(41); }
template<> Pocket::SlicedQuad* Pocket::GameObject::ReplaceComponent<Pocket::SlicedQuad>(GameObject* source) { ReplaceComponent(41, source); return (Pocket::SlicedQuad*) GetComponent(41); }
template<> void Pocket::GameObject::EnableComponent<Pocket::SlicedQuad>(bool enable) { EnableComponent(41, enable); }
template<> Pocket::SlicedTexture* Pocket::GameObject::GetComponent<Pocket::SlicedTexture>() { return (Pocket::SlicedTexture*) GetComponent(42); }
template<> Pocket::SlicedTexture* Pocket::GameObject::AddComponent<Pocket::SlicedTexture>() { AddComponent(42); return (Pocket::SlicedTexture*) GetComponent(42); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::SlicedTexture>() { RemoveComponent(42); }
template<> Pocket::SlicedTexture* Pocket::GameObject::CloneComponent<Pocket::SlicedTexture>(GameObject* source) { CloneComponent(42, source); return (Pocket::SlicedTexture*) GetComponent(42); }
template<> Pocket::SlicedTexture* Pocket::GameObject::ReplaceComponent<Pocket::SlicedTexture>(GameObject* source) { ReplaceComponent(42, source); return (Pocket::SlicedTexture*) GetComponent(42); }
template<> void Pocket::GameObject::EnableComponent<Pocket::SlicedTexture>(bool enable) { EnableComponent(42, enable); }
template<> Pocket::InputMapper* Pocket::GameObject::GetComponent<Pocket::InputMapper>() { return (Pocket::InputMapper*) GetComponent(43); }
template<> Pocket::InputMapper* Pocket::GameObject::AddComponent<Pocket::InputMapper>() { AddComponent(43); return (Pocket::InputMapper*) GetComponent(43); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::InputMapper>() { RemoveComponent(43); }
template<> Pocket::InputMapper* Pocket::GameObject::CloneComponent<Pocket::InputMapper>(GameObject* source) { CloneComponent(43, source); return (Pocket::InputMapper*) GetComponent(43); }
template<> Pocket::InputMapper* Pocket::GameObject::ReplaceComponent<Pocket::InputMapper>(GameObject* source) { ReplaceComponent(43, source); return (Pocket::InputMapper*) GetComponent(43); }
template<> void Pocket::GameObject::EnableComponent<Pocket::InputMapper>(bool enable) { EnableComponent(43, enable); }
template<> Pocket::InputController* Pocket::GameObject::GetComponent<Pocket::InputController>() { return (Pocket::InputController*) GetComponent(44); }
template<> Pocket::InputController* Pocket::GameObject::AddComponent<Pocket::InputController>() { AddComponent(44); return (Pocket::InputController*) GetComponent(44); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::InputController>() { RemoveComponent(44); }
template<> Pocket::InputController* Pocket::GameObject::CloneComponent<Pocket::InputController>(GameObject* source) { CloneComponent(44, source); return (Pocket::InputController*) GetComponent(44); }
template<> Pocket::InputController* Pocket::GameObject::ReplaceComponent<Pocket::InputController>(GameObject* source) { ReplaceComponent(44, source); return (Pocket::InputController*) GetComponent(44); }
template<> void Pocket::GameObject::EnableComponent<Pocket::InputController>(bool enable) { EnableComponent(44, enable); }
template<> Pocket::TouchableCanceller* Pocket::GameObject::GetComponent<Pocket::TouchableCanceller>() { return (Pocket::TouchableCanceller*) GetComponent(45); }
template<> Pocket::TouchableCanceller* Pocket::GameObject::AddComponent<Pocket::TouchableCanceller>() { AddComponent(45); return (Pocket::TouchableCanceller*) GetComponent(45); }
template<> void Pocket::GameObject::RemoveComponent<Pocket::TouchableCanceller>() { RemoveComponent(45); }
template<> Pocket::TouchableCanceller* Pocket::GameObject::CloneComponent<Pocket::TouchableCanceller>(GameObject* source) { CloneComponent(45, source); return (Pocket::TouchableCanceller*) GetComponent(45); }
template<> Pocket::TouchableCanceller* Pocket::GameObject::ReplaceComponent<Pocket::TouchableCanceller>(GameObject* source) { ReplaceComponent(45, source); return (Pocket::TouchableCanceller*) GetComponent(45); }
template<> void Pocket::GameObject::EnableComponent<Pocket::TouchableCanceller>(bool enable) { EnableComponent(45, enable); }
...
extern "C" IGameSystem* CreateSystem(int systemID) {
   switch (systemID) { 
      case 74: return new KillTriggerSystem();
      case 75: return new RectCollisionSystem();
      case 76: return new RotatorSystem();
      case 77: return new ScoreSystem();
      case 78: return new ScoreTriggerSystem();
      case 79: return new TransformControllerSystem();
      case 80: return new VelocityCollider();
      default: return 0;
   }
}
...
extern "C" int* GetSystems() {
 return new int[26] {-1,63,64,-1,0,64,9,-1,65,0,-1,66,20,-1,67,64,66,-1,0,68,44,-1,14,64,9,-2,};}
