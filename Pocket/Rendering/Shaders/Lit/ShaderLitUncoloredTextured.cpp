#include "ShaderLitUncoloredTextured.hpp"
using namespace Pocket;
using namespace std;

void ShaderLitUncoloredTextured::Initialize() {
...
void ShaderLitUncoloredTextured::OnStart(float* viewProjection) {
...
void ShaderLitUncoloredTextured::Bind() {
...
void ShaderLitUncoloredTextured::Apply(VisibleObject *visibleObject) {
